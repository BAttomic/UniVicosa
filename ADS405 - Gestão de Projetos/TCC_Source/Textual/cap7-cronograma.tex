...
1.2.1 & Projetar arquitetura Next.js + MongoDB & 1 semana & Sem. 3 & Sem. 3 \\ \hline
...
5.4.2 & Revisar OWASP Top 10 & 3 dias & Sem. 25 & Sem. 25 \\ \hline
5.4.3 & Teste de penetração (futuro) & 1 semana & Sem. 25-26 & Sem. 26 \\ \hline
5.4.4 & Remediar vulnerabilidades & 1 semana & Sem. 27 & Sem. 27 \\ \hline
5.4.5 & Revisão de segurança da aplicação & 1 semana & Sem. 28 & Sem. 28 \\ \hline
6.1.1 & Preparar ambiente produção & 3 dias & Sem. 28 & Sem. 28 \\ \hline
6.1.2 & Deploy (Easypanel) & 1 dia & Sem. 29 & Sem. 29 \\ \hline
...
\begin{itemize}
    \item \textbf{Autenticacao e perfil (2.1.*):} Folga total de 2 semanas. Pode ser desenvolvida em paralelo com eventos sem impacto no cronograma.
    \item \textbf{Ingressos digitais (2.4.*):} Folga total de 3 semanas. Permite refinamento e otimização sem pressão de prazo.
    \item \textbf{Dashboard organizador (3.2.*):} Folga total de 2 semanas. Interface pode ser desenvolvida de forma mais elaborada.
    \item \textbf{Aplicacao Check-in (3.3.*):} Folga total de 4 semanas. Permite testes extensivos em um evento piloto.
\end{itemize}
...
M4 & APIs core funcionais (Sem. 14) & APIs de autenticação, eventos e pedidos testadas, com regras críticas cobertas \\ \hline
M5 & Frontend completo (Sem. 19) & Interfaces comprador e organizador funcionais, testes usabilidade aprovados \\ \hline
M6 & Testes de qualidade aprovados (Sem. 25) & Testes unitários e E2E aprovados, \textit{build} de produção e verificação estática sem erros \\ \hline
...
\textbf{5. Integrações} & 4 semanas & Sem. 16-19 & Pagamento simulado (Asaas previsto), e-mail e fila de pré-venda integrados \\ \hline
\textbf{6. Testes e Qualidade} & 7 semanas & Sem. 19-25 & Suites de testes (unitários e E2E), \textit{build} e revisão de segurança da aplicação \\ \hline
...
\textbf{1. Iniciação e Planejamento} & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Workshops e requisitos & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Arquitetura e stack &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
\textbf{2. Infraestrutura} &  &  &  &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Provisionar cloud &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Segurança e CDN &  &  &  &  &  & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
\textbf{3. Backend APIs} &  &  &  &  &  &  & X & X & X & X & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
API Autenticação &  &  &  &  &  &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
API Eventos &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
API Pagamentos &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
API Ingressos &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
\textbf{4. Frontend} &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Interface Comprador &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Dashboard Organizador &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
App Check-in &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  \\ \hline
\textbf{5. Integrações} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Gateway Pagamento &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
E-mail e Filas &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
\textbf{6. Testes e QA} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X & X & X & X &  &  &  &  &  \\ \hline
Testes Unitários &  &  &  &  &  &  &  & X & X & X & X & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ \hline
Testes Integração &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  &  &  &  \\ \hline
Testes Carga &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  &  &  &  \\ \hline
Testes Segurança &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X & X & X &  &  \\ \hline
\textbf{7. Implantação} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X \\ \hline
Deploy Produção &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X &  \\ \hline
Documentação &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X \\ \hline
Treinamento &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X \\ \hline
\textbf{MARCOS} & v &  & v &  & v &  & v &  &  &  &  &  &  & v &  &  &  &  & v &  &  &  &  &  & v &  &  &  & v & v \\ \hline
\end{tabular}%
}
\end{table}
...
\textbf{Legenda:}
\begin{itemize}
    \item X = Período de execução da atividade
    \item v = Marco do projeto (gate de qualidade)
\end{itemize}
