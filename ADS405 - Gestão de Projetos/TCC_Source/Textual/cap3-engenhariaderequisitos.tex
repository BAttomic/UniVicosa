...
\begin{itemize}
    ...
    \item Gestão da equipe do evento (operadores) e distribuição de ingressos de cortesia a usuários por e-mail
\end{itemize}
...
\begin{itemize}
    ...
    \item Validação restrita ao organizador e aos operadores do evento; o administrador não realiza check-in
...
\begin{itemize}
    \item \textbf{Como} administrador, \textbf{quero} gerenciar todos os eventos e usuários (editar, excluir, analisar e distribuir ingressos), \textbf{para} garantir a governança e o suporte à operação da plataforma.
    \item \textbf{Critérios de Aceitação:} Acesso a todos os eventos e à gestão de usuários, sem participação no check-in.
\end{itemize}
