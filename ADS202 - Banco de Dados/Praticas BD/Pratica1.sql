-- Criação do esquema BernardoCordeiroMotta_Database
CREATE SCHEMA IF NOT EXISTS BernardoCordeiroMotta_Database;

-- Seleção do esquema criado
USE BernardoCordeiroMotta_Database;
